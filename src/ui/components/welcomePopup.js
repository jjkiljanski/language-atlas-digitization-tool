export function showWelcomePopup() {
  ...
  title.textContent = "Wersje Cyfrowe Polskich Atlasów Językowych";

  const subtitle1 = document.createElement("h3");
  subtitle1.textContent = "Cel";

  const generalMessage = document.createElement("p");
  generalMessage.textContent = "Ta strona prezentuje działanie środowiska do digitalizacji atlasów gwarowych i językowych. Jako przykład wybrano mapy i punkty z Atlasu Językowego Kaszubszczyzny oraz z Małego Atlasu Gwar Polskich. Interfejs oparty na \"klikaniu\" i \"przeciąganiu myszką\" pozwala na bardzo szybką digitalizację map z różnych atlasów językowych nawet osobom słabo radzącym sobie z komputerem.";

  const subtitle2 = document.createElement("h3");
  subtitle2.textContent = "Dla Pobudzenia Wyobraźni";
