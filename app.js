...
// The rest of imports
import { showWelcomePopup } from "./src/ui/components/welcomePopup.js";
import { loadAtlas, loadPointCoordsWithData, initMapMetadata, createEmptyCsvData, mergeCsvDataIntoApp} from './src/io.js';
import { cleanMap, cleanEditingEnv, resetEditedMapData, cleanLayerData, removeLayerFromEditedMap } from './src/cleaning.js';
import { updateLegend } from "./src/ui/components/legend.js";
import { preloadAllSymbols, getSymbol, getAllSymbolNames } from './src/ui/map-display/symbolLoader.js';
import { addSymbolLayerToMap, drawVoronoiLayers } from './src/ui/map-display/mapDisplayUtils.js';
import { createEmptyLegendDiv } from "./src/ui/components/legend.js";
import { createSidebarBackButton, createLabeledTextInput, createButton } from '/src/ui/components/elementDefinitions.js'
import { renderLayersSidebar } from '/src/ui/components/leftEditSidebar.js'
import { createLoadMapModal } from "./src/ui/components/loadMapModal.js";
